...
\subsection{Aliasing}
After a Fourier transform is applied low frequencies are about the same but high frequencies appear to have a larger magnitude compared to the original signal. This is due to shifting by $\w_s$ and is called aliasing.
\begin{figure}[ht!]
	\centering
	\includegraphics[width=.5\textwidth]{images/02aliasing}
	\caption{Effects of aliasing with original and sampled signal.}
	\label{fig:02aliasing}
\end{figure}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=.5\textwidth]{images/02aafilter}
